...
def append_electric_ducted_fan_residual_and_unknown(propulsor,segment):
    ...
    segment.state.numerics.solver.upper_bounds[propulsor.tag + '_motor_current'] =   rp.inf* ones_row(1) 
    segment.state.numerics.solver.lower_bounds[propulsor.tag + '_motor_current'] =  - rp.inf* ones_row(1) 
