...
def design_internal_combustion_engine(ICE, number_of_stations=20, solver_name='SLSQP', iterations=200,
    ...
    **Major Assumptions**
    ...
    operating_state       = setup_operating_conditions(ICE,velocity_range=rp.array([V]), altitude = 0, angle_of_attack=0, temperature_deviation=0)  
    operating_state.conditions.energy.propulsors[ICE.tag].throttle = operating_state.conditions.energy.propulsors[ICE.tag].throttle.at[:,0].set(1.0)
