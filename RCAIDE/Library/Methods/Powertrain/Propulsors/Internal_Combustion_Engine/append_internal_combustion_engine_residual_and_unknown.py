...
def append_internal_combustion_engine_residual_and_unknown(propulsor, segment):
    ...
    segment.state.numerics.solver.upper_bounds[propulsor.tag + '_propeller_omega'] =   rp.inf* ones_row(1) 
    segment.state.numerics.solver.lower_bounds[propulsor.tag + '_propeller_omega'] = - rp.inf* ones_row(1)
