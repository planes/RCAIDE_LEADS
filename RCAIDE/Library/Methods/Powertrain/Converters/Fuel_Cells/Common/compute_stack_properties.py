...
def compute_stack_properties(fuel_cell_stack):
    ...
    **Theory**
    ...
    if type(fuel_cell_stack) == RCAIDE.Library.Components.Powertrain.Converters.Generic_Fuel_Cell_Stack:
        ...
        fuel_cell_stack_conditions.fuel_cell.stagnation_temperature = fuel_cell_stack_conditions.fuel_cell.stagnation_temperature.at[t_idx, 0].set(atmo_data.temperature[0, 0])
        fuel_cell_stack_conditions.fuel_cell.stagnation_pressure = fuel_cell_stack_conditions.fuel_cell.stagnation_pressure.at[t_idx, 0].set(atmo_data.pressure[0, 0])
        fuel_cell_stack_conditions.fuel_cell.pressure_drop = fuel_cell_stack_conditions.fuel_cell.pressure_drop.at[t_idx, 0].set(fuel_cell.rated_p_drop_fc)
        fuel_cell_stack_conditions.fuel_cell.stack_temperature = fuel_cell_stack_conditions.fuel_cell.stack_temperature.at[t_idx, 0].set(fuel_cell.stack_temperature)
