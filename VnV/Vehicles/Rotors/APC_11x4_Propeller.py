...
def APC_11x4_Propeller():          
    ...
    prop.thrust_angle               = 0. 
    dimensionless_radius_chord      = rp.array([[0.1552847467328054, 0.11186397023752742 ],[0.2053658303920633, 0.13710483640179336 ],[0.2554278355432604, 0.15993608699799672 ],
    ...
    dimensionless_radius_twist      = rp.array([[0.1452380952380954, 19.68937875751503   ],[0.1976190476190478, 21.793587174348698  ],[0.25, 22.494989979959918                ],
    ...
    # estimate thickness 
    r_R_data                        = rp.array([0.155,0.275,0.367,0.449,0.5,0.55,
                                                0.6,0.65,0.7,0.75,0.8,0.85,0.9,0.95,0.99])
    t_b_data                        = rp.array([0.122,0.105,0.077,0.061,0.055,0.049,0.045,0.041,0.038
                                                ,0.035,0.033,0.031,0.029,0.027,0.026]) 
    b_D_data                        = rp.array([0.14485,0.14587,0.1481,
    ...
    prop.airfoil_polar_stations     = list(rp.zeros(len(prop.radius_distribution)).astype(int)) 
    return prop